...
public final class StudySession: ObservableObject {
  ...
  ///
  /// Beyond the passage widens it. Off the staves entirely, it deselects, the
  /// way tapping outside text does. Inside it, nothing — confirming belongs to
  /// the floating button alone, so no tap ever commits by accident.
